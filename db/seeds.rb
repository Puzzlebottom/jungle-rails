...
user1 = User.find_or_create_by!(email: 'headmaster@hogwarts.wiz') do |user|
  user.first_name = 'Albus'
  user.last_name = 'Dumbleedoo'
  user.password = 'grindelwald'
  user.password_confirmation = 'grindelwald'
end

puts 'Adding Reviews...'

prod1.reviews.create!({ user_id: 1, description: 'It tasted delicious!', rating: 5 })
prod2.reviews.create!({ user_id: 1, description: 'It tasted terrible!', rating: 1 })
